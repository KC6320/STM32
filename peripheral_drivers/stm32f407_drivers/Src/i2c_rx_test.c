...
int main(void)
{
	...
	uint8_t len;
		...
		I2C_master_tx(&I2C1Handle,&command,1,SLAVE_ADDR,I2C_NO_REPEATED_START);

		// read len
		I2C_master_rx(&I2C1Handle, &len, 1, SLAVE_ADDR, I2C_NO_REPEATED_START);
		...
		// read len
		I2C_master_rx(&I2C1Handle, rx_buffer, len, SLAVE_ADDR, I2C_NO_REPEATED_START);
